...
/**
 * input _err_check - helper function for sanitizer
 * @ptr: pointer
...
/**
 * err_message - a function that prints error messages
 * @arg0: cmd that is causing error
 * @arg1: first arg
 */
